...
const GENERATE_PROMPT = (topic) => `你是一个日语句子拆解助手。请生成一句关于「${topic}」的 N1-N2 难度日语长句，并进行四层拆解。你的所有explanation必须采用"日语解释 +（中文：中文解释）"的固定格式，绝对不要使用英文。
...
const ANALYZE_PROMPT = (sentence) => `你是一个日语句子拆解助手。请对以下日语句子进行四层拆解。你的所有explanation必须采用"日语解释 +（中文：中文解释）"的固定格式，绝对不要使用英文。
