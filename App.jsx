...
const GENERATE_PROMPT = (topic) => `你是一个日语句子拆解助手。请生成一句关于「${topic}」的 N1-N2 难度日语长句，并进行四层拆解。
...
<explanation>这块修饰成分在句中起什么作用</explanation>
</part>
<part>
<text>另一个修饰成分</text>
<role>功能标签</role>
<explanation>作用说明</explanation>
</part>
<grammar>
<pattern>语法条目，如 ～にもかかわらず</pattern>
<meaning>语法含义</meaning>
<explanation>在本句中的具体用法和语感说明</explanation>
<level>N1 或 N2</level>
</grammar>
<grammar>
<pattern>另一个语法点</pattern>
<meaning>含义</meaning>
<explanation>用法说明</explanation>
<level>级别</level>
</grammar>
...
const ANALYZE_PROMPT = (sentence) => `你是一个日语句子拆解助手。请对以下日语句子进行四层拆解。
...
<meaning>语法含义</meaning>
<explanation>在本句中的具体用法和语感说明。必须在解释后补充：【中文总结：...】</explanation>
